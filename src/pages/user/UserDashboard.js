                                                        ...
                                                        <ul className="-my-7 divide-y divide-gray-200">
                                                            ...
                                                            >
                                                                ...
                                                                <div className="ml-auto flex flex-col items-end justify-between">
                                                                    ...
                                                                    <button onClick={() => deleteProduct(order.id)} className="ml-auto flex flex-col items-end text font-bold bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded-lg">cancel</button>
